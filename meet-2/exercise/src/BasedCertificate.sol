...
contract BasedCertificate is ERC721, ERC721URIStorage, ERC721Burnable, Ownable {
    uint256 private _nextTokenId = 1; // Start from 1 to avoid conflict with mapping default value
    ...
    function issueCertificate(
        ...
        string memory certHash = string(abi.encodePacked(to, recipientName, course, issuer));
